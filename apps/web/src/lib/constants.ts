...
export const STATUS_STYLES: Record<RunStatus, { text: string; bg: string; border: string; dot: string }> = {
  ...
  failed:   { text: "text-critical",  bg: "bg-critical/10",  border: "border-critical/30",  dot: "bg-critical" },
};
